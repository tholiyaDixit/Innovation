...
interface JsUseFullFunctionCardProps {
  img: any;
  title: string;
  descriptions: string;
  navigate: string;
...
const JsUseFullFunctionCard = (props: JsUseFullFunctionCardProps) => {
  return (
    <>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 relative shadow-xl overflow-hidden group rounded-xl p-5 transition-all duration-500 transform">
            <div className="flex items-center gap-4">
              ...
              <div className="w-fit transition-all transform duration-500">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-200 opacity-0 transform transition-all duration-500" >
                  {props.descriptions}
                </div>
              </div>
            </div>
            <div className="absolute -bottom-16 transition-all duration-500 bg-gray-600 dark:bg-gray-100 right-1 rounded-lg">
...
export default JsUseFullFunctionCard;
